$(function(){
    ...
    function myFn(){
        ...
        var ulW =  $('.lunBo .ulDiv ul').width();
         ...
         //console.log(ulDivW);
        if(ulW > ulDivW){
            $('.lunBo .bottomDiv .arrowLBtn').css('background','url(./img/icon9.png) no-repeat');
            $('.lunBo .bottomDiv .arrowRBtn').css('background','url(./img/icon10.png) no-repeat');
        }else{
            $('.lunBo .bottomDiv .arrowLBtn').css('background','url(./img/icon9.1.png) no-repeat');
            $('.lunBo .bottomDiv .arrowRBtn').css('background','url(./img/icon10.1.png) no-repeat');
        }
    }
    myFn();
